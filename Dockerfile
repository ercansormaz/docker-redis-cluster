...
LABEL org.opencontainers.image.title="Redis Cluster" \
      ...
      org.opencontainers.image.ref.name="ercansormaz/redis-cluster:8.6.2"

# Download create-cluster script from redis repository
ADD https://raw.githubusercontent.com/redis/redis/refs/tags/8.6.2/utils/create-cluster/create-cluster /usr/local/bin/create-cluster
