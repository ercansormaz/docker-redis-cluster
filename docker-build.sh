...
docker buildx build --platform linux/amd64,linux/arm64 -f 8.2/Dockerfile --push -t ercansormaz/redis-cluster:8.2.3 .
docker buildx build --platform linux/amd64,linux/arm64 --push -t ercansormaz/redis-cluster:8.4.0 -t ercansormaz/redis-cluster:latest .
