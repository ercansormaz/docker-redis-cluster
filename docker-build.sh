...
docker buildx build --platform linux/amd64,linux/arm64 --push -t ercansormaz/redis-cluster:8.6.2 -t ercansormaz/redis-cluster:8.6 -t ercansormaz/redis-cluster:latest .
